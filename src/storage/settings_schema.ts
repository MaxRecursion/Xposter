...
export const SETTINGS_SCHEMA: SettingSpec[] = [
  ...
  { key: 'min_score', type: 'int', default: '60', min: 0, max: 100, writable: true },
  ...
  { key: 'max_replies_per_day', type: 'int', default: '8', min: 1, max: 50, writable: true },
  ...
  { key: 'follow_back_candidates_per_run', type: 'int', default: '5', min: 1, max: 50, writable: true },
  ...
  { key: 'original_posts_per_day', type: 'int', default: '2', min: 1, max: 15, writable: true },
  ...
  { key: 'audience_sync_enabled', type: 'bool', default: 'true', writable: true },
